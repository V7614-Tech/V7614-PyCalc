...
2. **"Continue" bottleneck**
   ...
   - **Fixed?:** Yes, the fix for this bug is in the unreleased `V7614 PyCalc 1.0.0 beta`. `V7614 PyCalc 1.0.0 beta` will be released on Sunday 27th July 2025. If you don't want to install a beta version, you're out of luck and will have to wait for `V7614 PyCalc 1.0.0`'s full release later on Wednesday, 30th July 2025.
   - **Workaround:** This bug is a hard one. There are **NO** workarounds for this bug.
---
